...
class MainWindow():
    ...
    def Display_1(self):
        ...
        if self.ui.checkBox_1.isChecked():
            ...
            data1.head(20000).plot(x='DeviceTimeStamp', y='VL1', ax=axes)
            plt.show()

        elif self.ui.checkBox_2.isChecked():
            axes.set_ylabel("Current (A)")
            data1.head(20000).plot(x='DeviceTimeStamp', y='IL1', ax=axes)
            plt.show()

        elif self.ui.checkBox_3.isChecked():
            axes.set_ylabel("Power (W)")
            data2.head(20000).plot(x='DeviceTimeStamp', y='KW', ax=axes)
            plt.show()
